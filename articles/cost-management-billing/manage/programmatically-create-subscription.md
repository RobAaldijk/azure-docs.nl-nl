---
title: Programmatisch Azure-abonnementen maken met de nieuwste API's
description: Leer hoe u programmatisch Azure-abonnementen kunt maken met behulp van de nieuwste versies van REST API, Azure CLI en Azure PowerShell.
author: bandersmsft
...
Dit artikel helpt u programmatisch Azure-abonnementen te maken met behulp van de meest recente API-versies. Als u nog de oudere preview-versie gebruikt, raadpleegt u [Programmatisch Azure-abonnementen maken met preview-API's](programmatically-create-subscription-preview.md). 
...
Gebruik de informatie in de volgende secties om MCA-abonnementen te maken.
...
Gebruik de informatie in de volgende secties om MPA-abonnementen te maken.
...
U kunt abonnementen maken op uw Azure Resource Manager-sjabloon (ARM-sjabloon), zodat u uw implementatieprocessen voor productie en testen kunt automatiseren. In het volgende voorbeeld gebruikt u een ARM-sjabloon voor het maken van een Azure-abonnement en een Azure-resourcegroep.
